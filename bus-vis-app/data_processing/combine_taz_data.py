...
# %%
income_df = pd.read_csv('./data_input/3. Supplementary Data/5. Marginal_Income.csv')
household_df = pd.read_csv('./data_input/3. Supplementary Data/6. SE_File_v83_SE19_Net19.csv')
